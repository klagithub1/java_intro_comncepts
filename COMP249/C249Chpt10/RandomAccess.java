...
public class RandomAccess {
	...
	public static void main (String[] aArguments) throws IOException{
		...
		rf.seek((3 * EmployeeRecord.RECORD_SIZE) + EmployeeRecord.SALARY_OFFSET);
		rf.writeDouble(88.88);
		
		
		System.out.println("Changing age of employee #7 to 16...\n");
		rf.seek((6 * EmployeeRecord.RECORD_SIZE) + EmployeeRecord.AGE_OFFSET);
		rf.writeByte(16);
