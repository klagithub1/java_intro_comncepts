...
<body>
	...
	<nav>
		<ul>
			<li class="active"><a href="group_browse.jsp">Browse Groups</a></li>
	...
	<div class="content">
		<table class="center">
			...
			<thead>
				<tr><td>1</td><td>Super Group</td><td>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</td></tr>
			</thead>
		</table>
	</div>
</body>
